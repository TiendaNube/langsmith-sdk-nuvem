...
process.env.LANGSMITH_***REMOVED*** = "<YOUR-LANGSMITH-API-KEY>";
...
export LANGSMITH_***REMOVED***=<YOUR-LANGSMITH-API-KEY>
...
```shell
export LANGSMITH_TRACING="true";
export LANGSMITH_***REMOVED***=<your-api-key>
```
...
const client = new MistralClient(process.env.MISTRAL_***REMOVED*** || "");
...
const parentRunConfig: RunTreeConfig = {
  ...
  // apiKey: "Defaults to the LANGSMITH_***REMOVED*** env var"
};
...
const client = new Client({
  ...
  // apiKey: "my_api_key", // Defaults to the LANGSMITH_***REMOVED*** env var
  /* callerOptions: {

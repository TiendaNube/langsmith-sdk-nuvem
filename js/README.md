...
process.env["LANGCHAIN_***REMOVED***"] = "<YOUR-LANGSMITH-API-KEY>";
...
```shell
export LANGCHAIN_***REMOVED***=<YOUR-LANGSMITH-API-KEY>
...
```shell
export LANGCHAIN_***REMOVED***=<your-api-key>
```
...
const parentRunConfig: RunTreeConfig = {
  ...
  // apiKey: "Defaults to the LANGCHAIN_***REMOVED*** env var"
};
...
const client = new Client({
  ...
  // apiKey: "my_api_key", // Defaults to the LANGCHAIN_***REMOVED*** env var
  /* callerOptions: {

...
def langchain_client(monkeypatch: pytest.MonkeyPatch) -> Client:
    ...
    monkeypatch.setenv("LANGCHAIN_***REMOVED***", "ls__29e47afc8ad24323aef27444617fb8db")
    return Client()
...
def test_error_surfaced_invalid_uri(monkeypatch: pytest.MonkeyPatch, uri: str) -> None:
    ...
    monkeypatch.setenv("LANGCHAIN_***REMOVED***", "test")
    client = Client()
...
def test_get_info() -> None:
    langchain_client = Client(api_key="***REMOVED***")

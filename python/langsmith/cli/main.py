...
class LangSmithCommand:
    ...
    def pull(
        ...
        *,
        ...
        Args:
            version: The LangSmith version to use for LangSmith. Defaults to 0.5.0
        """
        ...
        *,
        ...
        Args:
            openai_api_key: The OpenAI API key to use for LangSmith
                ...
                OPENAI_***REMOVED*** environment variable. If neither are provided,
        ...
        if openai_api_key is not None:
            os.environ["OPENAI_***REMOVED***"] = openai_api_key
...
def main() -> None:
    ...
    server_start_parser.add_argument(
        "--openai-api-key",
        default=os.getenv("OPENAI_***REMOVED***"),
    ...
    server_start_parser.add_argument(
        "--version",
        default="0.5.0",
        help="The LangSmith version to use for LangSmith. Defaults to 0.5.0.",
    )
